...
public class HandlerExecutionChain {
    ...
    public HandlerExecutionChain(Handler handler, HandlerInterceptor... interceptors) {
        this(handler, (interceptors != null ? Arrays.asList(interceptors) : Collections.emptyList()));
    }

    public HandlerExecutionChain(Handler handler, List<HandlerInterceptor> interceptorList) {
